package com.bingo.bingomaster.bingomovil.servicios.cripto;
...
/**
 * Created by luisgabrielcorredorcombita on 29/10/17.
 */

public class criptoUtil {
    public String sKey = "1y1+OeNPEmhzo6dF6HYmpk0VWCmlyq7FCWdJ4IFwm4Q=";
